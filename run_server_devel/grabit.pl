...
$local_directory = "/home/wiktor/Projects/EDICT/WP1.4/grabit";  #Store grabbed files here
...
sub save_image {  #copy web FILE to local DOWNLOAD location
    my ($file, $dir, $download) = @_;

    my $user_agent = LWP::UserAgent->new;
    my $request = HTTP::Request->new('GET', $file);  
    my $response = $user_agent->request ($request, "$dir/$download");
    #move($download,$dir);  
}  
#LIST LINKS---------------------------------------------------------------------
